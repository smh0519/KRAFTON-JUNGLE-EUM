    ...
    return (
        <>
            <div
                ...
                onClick={onClose}
            />
            <div className="absolute right-0 mt-2 w-72 bg-[#1f1f1f] border border-white/10 shadow-lg z-20 rounded-md overflow-hidden">
                {/* User Info */}
                <div className="p-4 border-b border-white/5 bg-white/[0.02]">
                    ...
                    {myPresence?.custom_status_text && (
                        <div className="text-sm text-white/70 bg-white/5 p-2 rounded border border-white/5 mt-2">
                ...
                <div className="p-2 border-b border-white/5">
                    <p className="px-2 py-1 text-xs font-semibold text-white/40 uppercase">상태 설정</p>
                    {[
                        ...
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-3 py-2 text-sm rounded hover:bg-white/5 transition-colors ${currentStatus === item.id ? "bg-white/[0.03]" : ""}`}
                        >
                ...
                <div className="p-2">
                    <button
                        ...
                        className="w-full px-3 py-2 text-left text-sm text-white/70 hover:bg-white/5 rounded transition-colors flex items-center gap-2"
                    >
                    ...
                    <button
                        onClick={onLogout}
                        className="w-full px-3 py-2 text-left text-sm text-red-500 hover:bg-red-500/10 rounded transition-colors flex items-center gap-2"
                    >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
